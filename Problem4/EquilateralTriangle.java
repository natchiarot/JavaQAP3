...
public class EquilateralTriangle extends Shape {
    ...
    // Override the scale method to scale the lengths of all sides by a given scalingFactor
    @Override
    public void scale(double scalingFactor) {
        // Scale the lengths of all sides by multiplying them with the scaling factor
        side1 = side1 * scalingFactor;
        side2 = side2 * scalingFactor;
        side3 = side3 * scalingFactor;
    }
